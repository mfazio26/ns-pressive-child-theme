...
/**
 * Renderable Template:
 * Applied to Single Legacy Course. Renders a Legacy Course's Cover and Title. 
 * Please note, this currently only supports rendering a sidebar-style widget.
 *
 * @since      1.0.0
 * @package    notsalmon
 * @author     Mike Fazio <mike@mfazio.com>
 */
class Courses_SidebarCoverTitle extends Renderable {

	/**
     * Overriden method
     * Renders the Legacy Course's Cover and Title sidebar widget.
     *
     * Please note, this renders identically to `Books_SidebarCoverTitle`. The only 
	...
	public function render($context = array()){
		...
		// if the id is defined and the id is a single Legacy Course...
		if ($id && PostTypeUtil::is_legacy_course_single($id)){
			...
			?>
				...
				<section class="ns-sidebar-widget-cover ns-sidebar-widget-cover--course">
