...
/**
 * Renderable Template:
 * Renders the current Book's related Books and Courses Box. Please note, related 
 * Courses point to MastersInLife.com course and not our internal legacy courses.
 *
 * @since      1.0.0
 * @package    notsalmon
 * @author     Mike Fazio <mike@mfazio.com>
 */
class Books_RelatedBox extends Renderable {

	/**
     * Overriden method
     * Renders a Book's related books and courses box. 
     * 
     ...
     *
     * Please note, this renders identically to `Courses_RelatedBox`. The only reason 
	...
	public function render($context = array()){
		...
		$related = get_field("books_related");
